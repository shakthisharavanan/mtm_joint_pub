...
class teacher_ctrl(object):
    ...
    def __init__(self):
        ...
        self.elbow_pub = rospy.Publisher('/mtm_teacher/right_elbow_pitch_joint/SetPositionTarget', Float64, queue_size=10)
        self.out_yaw_pub = rospy.Publisher('/mtm_teacher/right_outer_yaw_joint/SetPositionTarget', Float64, queue_size=10)
        self.shoulder_pub = rospy.Publisher('/mtm_teacher/right_shoulder_pitch_joint/SetPositionTarget', Float64, queue_size=10)
        self.pitch_pub = rospy.Publisher('/mtm_teacher/right_wrist_pitch_joint/SetPositionTarget', Float64, queue_size=10)
        self.platform_pub = rospy.Publisher('/mtm_teacher/right_wrist_platform_joint/SetPositionTarget', Float64, queue_size=10)
        self.roll_pub = rospy.Publisher('/mtm_teacher/right_wrist_roll_joint/SetPositionTarget', Float64, queue_size=10)
        self.yaw_pub = rospy.Publisher('/mtm_teacher/right_wrist_yaw_joint/SetPositionTarget', Float64, queue_size=10)
